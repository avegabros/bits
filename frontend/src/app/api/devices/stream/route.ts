...
/**
 * Next.js Route Handler that pipes the backend's device SSE stream
...
export async function GET(request: NextRequest) {
    ...
    try {
        const url = `${backendUrl}/api/devices/stream`
        ...
        console.log('[SSE Proxy] Piping device SSE stream to client')
