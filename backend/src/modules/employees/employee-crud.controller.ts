...
/**
 * Shared helper to validate shift conflicts between multiple assigned shifts.
 * Day-aware: only validates time overlap / minimum gap when shifts share at
 * least one common work day. Shifts on completely different days are always allowed.
